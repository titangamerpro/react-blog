...
function App() {
  ...
  return (
    <Routes>
      <Route path="/" element={<Layout allPosts={allPosts} />}>
        ...
        <Route
          path="edit/:id"
          element={<EditPost allPosts={allPosts} setAllPosts={setAllPosts} />}
        />
        <Route path="post">
          <Route
            path=":id"
            element={<Post handlDelete={handlDelete} allPosts={allPosts} />}
          />
        </Route>
